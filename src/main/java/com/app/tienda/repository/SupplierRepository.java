...
public interface SupplierRepository extends JpaRepository<SupplierEntity, Long> {
  ...
  @Query(value = "SELECT * FROM SUPPLIERS WHERE name = :name", nativeQuery = true)
   ...
   */
  @Query(value = "SELECT * FROM SUPPLIERS s INNER JOIN ADDRESS a ON s.address_id = a.id WHERE a.city = :city", nativeQuery = true)
